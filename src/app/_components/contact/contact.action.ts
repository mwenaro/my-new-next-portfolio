...
<body>
    ...
    <div class="container">
        <div class="header">
            <img src="your-logo.png" alt="DevRam Logo" class="logo">
        </div>
        <div class="content">
            <h1>Thank You for Your Message!</h1>
            <p>Thank you for reaching out! Your message has been received, and I'll get back to you as soon as possible.</p>
            <span class="from">Best regards,<br><b>Mwero Abdalla</b></span>
        </div>
        <div class="footer">
            <p>Visit my website: <a href="https://mwero.me">mwero.me</a></p>
            <span>Email: <a href="mailto:mweroabdalla@gmail.com">mweroabdalla@gmail.com</a></span>
        </div>
    </div>
